...
public class Config {
	...
	public static String ROOT_DIRECTORY = "/irc/conf/";
	public static File cnf = new File(ROOT_DIRECTORY + "/config.yml");
	public static File cmd = new File(ROOT_DIRECTORY + "/custom-commands.yml");
